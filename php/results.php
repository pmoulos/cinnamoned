	...
	<td class="mainContainer" style="height:80%;"> 
		<table class="mainContainer">
			...
			<td class="mainContainer">
				<p class="title" style="letter-spacing: normal">Finished!</p>
				<table id="results_table" class="innerTable"></table>
				<table id="norm_diagnostics" class="innerTable"></table>
			</td>
